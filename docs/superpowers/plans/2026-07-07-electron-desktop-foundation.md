...
- [ ] **Step 2: Run repo-level guardrails**
...
- [ ] **Step 4: Manual product loop smoke test**
...
- [ ] **Step 5: Stop app and confirm cleanup**
...
- [ ] **Step 1: Write failing docs/source assertions if existing tests cover startup docs**
...
- [ ] **Step 2: Update user-facing startup docs**
