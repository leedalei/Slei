...
describe("shared toast feedback", () => {
  ...
  it("renders polite live-region feedback", () => {
    ...
    expect(html).toContain('data-slot="toast"');
    expect(html).toContain("bg-popover");
    expect(html).toContain("text-popover-foreground");
    expect(html).not.toContain('data-slot="notification-surface"');
    ...
    expect(html).toContain('data-slot="toast-content"');
    expect(html).toContain("items-center");
    expect(html).toContain('data-slot="toast-icon"');
