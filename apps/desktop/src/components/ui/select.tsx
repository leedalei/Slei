...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      "flex h-10 w-full items-center justify-between gap-2 rounded-lg border border-[var(--tabs-control-border)] bg-[var(--tabs-control-bg)] px-4 py-2 text-sm text-foreground",
      "placeholder:text-muted-foreground/70 shadow-[var(--tabs-pill-shadow)] transition-[background-color,border-color,color,box-shadow] duration-200",
...
const GlassSelectGroup = SelectGroup
const GlassSelectValue = SelectValue
const GlassSelectTrigger = SelectTrigger
const GlassSelectContent = SelectContent
const GlassSelectLabel = SelectLabel
const GlassSelectItem = SelectItem
const GlassSelectSeparator = SelectSeparator
const GlassSelectScrollUpButton = SelectScrollUpButton
const GlassSelectScrollDownButton = SelectScrollDownButton
