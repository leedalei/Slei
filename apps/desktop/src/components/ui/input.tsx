  ...
  return (
    <input
      ...
      className={cn(
        ...
        chrome === "inset"
          ? "border-input bg-muted/40 slei-inset-small slei-inset-focus-small focus-visible:border-ring disabled:bg-input/50 dark:bg-muted/30 dark:disabled:bg-input/80"
