  ...
  return (
    <input
      ...
      className={cn(
        ...
        chrome === "inset"
          ? "border-[var(--slei-inset-border)] bg-muted/40 slei-inset-medium slei-inset-focus-medium focus-visible:border-ring disabled:bg-input/50 dark:bg-muted/30 dark:disabled:bg-input/80"
