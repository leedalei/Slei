  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=soft]/tabs-list:data-active:ring-1 group-data-[variant=soft]/tabs-list:data-active:ring-border/60 group-data-[variant=soft]/tabs-list:data-active:shadow-sm",
