  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg text-muted-foreground group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        soft: "bg-muted/70 p-1 shadow-[var(--slei-shadow-inset-sm)] group-data-[orientation=horizontal]/tabs:h-9",
      },
    },
    defaultVariants: {
      variant: "default",
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-1.5 py-0.5 text-sm font-medium whitespace-nowrap text-foreground/60 transition-all group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50 has-data-[icon=inline-end]:pr-1 has-data-[icon=inline-start]:pl-1 dark:text-muted-foreground dark:hover:text-foreground group-data-[variant=default]/tabs-list:data-active:shadow-[var(--slei-shadow-raised-xs)] group-data-[variant=line]/tabs-list:data-active:shadow-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        ...
        "group-data-[variant=soft]/tabs-list:data-active:border-[var(--slei-raised-border)] group-data-[variant=soft]/tabs-list:data-active:bg-card group-data-[variant=soft]/tabs-list:data-active:text-card-foreground group-data-[variant=soft]/tabs-list:data-active:ring-1 group-data-[variant=soft]/tabs-list:data-active:ring-border/60 group-data-[variant=soft]/tabs-list:data-active:shadow-[var(--slei-shadow-raised-xs)] dark:group-data-[variant=soft]/tabs-list:data-active:bg-card dark:group-data-[variant=soft]/tabs-list:data-active:text-card-foreground",
