  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "raised" && "border-transparent bg-card slei-raised-large",
        variant === "inset" && "border-border/60 bg-muted/40 slei-inset-large",
        variant === "interactive" &&
          "cursor-pointer border-border/70 bg-card slei-raised-small transition-[background-color,box-shadow,color] hover:slei-raised-medium",
        className
      )}
      {...props}
    />
