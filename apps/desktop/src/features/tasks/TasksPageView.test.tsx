...
describe("TasksPage filters", () => {
  ...
  it("opens the task thread as an unmasked right slide-over with a bottom reply composer", async () => {
    ...
    expect(drawer?.className).toContain("bg-background/80");
    expect(drawer?.className).toContain("dark:bg-background/70");
    expect(drawer?.className).toContain("border-border/60");
