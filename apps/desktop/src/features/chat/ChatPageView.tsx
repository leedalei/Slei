          ...
          {effectiveChannelView === "chat" ? (
            <div className="grid min-h-0 grid-rows-[minmax(0,1fr)_auto]" data-testid="slei-channel-chat-column">
              <div className="relative min-h-0">
                ...
                {showScrollToBottom ? (
                  <Button
                    className="absolute bottom-2.5 left-1/2 z-10 h-8 -translate-x-1/2 border-primary bg-white px-3.5 text-primary shadow-[var(--slei-shadow-raised-sm)] hover:bg-white hover:text-primary"
              ...
              <footer className="border-t bg-background/95">
                ...
                <form className="px-4 py-3" onSubmit={(event) => { event.preventDefault(); void submitMessage(); }}>
                  <SoftPanel className="grid gap-2 p-3" data-testid="slei-composer-surface" variant="inset">
