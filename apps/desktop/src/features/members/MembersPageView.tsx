                ...
                {canMessage ? (
                  <AvatarBadge asChild>
                    <button
                      ...
                      data-testid="slei-member-header-message-button"
                      onClick={() => input.onMessage?.(selectedMember.id)}
                      type="button"
                    >
                  ...
                  <div className="grid min-w-0 gap-3 md:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
                    <div className="grid min-w-0 gap-1">
                      <EditableDetailField
                        ...
                        readClassName="min-w-0 whitespace-normal break-words text-sm leading-6"
